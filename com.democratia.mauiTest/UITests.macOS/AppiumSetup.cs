...
namespace UITests
{
    public class AppiumSetup : IDisposable
    {
        ...
        private void RunTestsRemotelyOnMac()
        {
            ...
            var testCommand = $"ssh {MacUser}@{MacIp} \"/opt/homebrew/bin/appium & sleep 5 && cd {MacProjectDir} && /Users/m1/Library/Caches/maui/PairToMac/SDKs/dotnet/dotnet test com.democratia.mauiTest/UITests.macOS/UITests.macOS.csproj --logger 'trx;LogFileName=results.trx'\"";
