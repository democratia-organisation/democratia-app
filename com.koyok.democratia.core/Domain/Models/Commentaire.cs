...
{
    public class Commentaire(int id_commentaire, string? contenu_message, DateTime horodatage, int nb_signalement, string nom_auteur, string prenom_auteur, Role role, int id_internaute)
    {
        public int idCommentaire = id_commentaire;

        public string? contenuMessage = contenu_message;
