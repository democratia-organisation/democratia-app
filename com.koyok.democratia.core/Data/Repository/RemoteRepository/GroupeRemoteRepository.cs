...
{
    internal class GroupeRemoteRepository(HttpClient client, IEnumerable<IRemoteToDomain> remotes) 
        : RemoteBaseRepository(client, remotes.OfType<GroupeRemoteToDomain>().FirstOrDefault()!), IGroupeRepository
    {
