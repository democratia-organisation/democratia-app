...
{
    internal class ThematiqueRemoteRepository(HttpClient client, IEnumerable<IRemoteToDomain> remotes)
        : RemoteBaseRepository(client, remotes.OfType<ThematiqueRemoteToDomain>().FirstOrDefault()!), IThematiqueRepository
    {
